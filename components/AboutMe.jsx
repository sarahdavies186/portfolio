...
export default function AboutMe() {
  return (
    <div
      id="about"
      className="grid grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 py-20 px-4 container"
    >
      ...
      <div className="p-4 lg:pr-40">
        <h3 className="font-syne-medium text-2xl pt-2 pb-2 text-center lg:text-left">
          Welcome!
        </h3>
        <p className="font-sen pt-2 mb-8 text-center lg:text-left">
          My name is Sarah and I am a software developer looking for a new role.
        ...
        <div className="flex justify-center items-center lg:items-start lg:justify-start">
          ...
          <a
            className="font-sportinggrotesqueregular bg-transparent py-2 px-4 border ml-2 hover:text-green ease-in-out duration-200"
